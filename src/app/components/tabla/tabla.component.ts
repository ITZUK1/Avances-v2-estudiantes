...
export class TablaComponent {
  materias: Materia[] = [
    ...
    { nombre: 'Química I', profesor: 'Ing. Paula Ruiz', horario: 'Jueves 8:00 - 10:00', semestre: 7 },
    { nombre: 'Historia', profesor: 'Lic. Ana Torres', horario: 'Viernes 9:00 - 11:00', semestre: 8 },
    { nombre: 'Matemáticas II', profesor: 'Dr. Juan Pérez', horario: 'Lunes 10:00 - 12:00', semestre: 4 },
    { nombre: 'Programación II', profesor: 'Ing. María López', horario: 'Martes 12:00 - 14:00', semestre: 9 },
    { nombre: 'Física II', profesor: 'Dr. Carlos Gómez', horario: 'Miércoles 16:00 - 18:00', semestre: 2 },
    { nombre: 'Química II', profesor: 'Ing. Paula Ruiz', horario: 'Jueves 10:00 - 12:00', semestre: 3 },
